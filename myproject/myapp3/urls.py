...
from .views import hello, HelloView, year_post, MonthPost, post_detail, my_view, TemplIf, author_posts, post_full
...
urlpatterns = [
    ...
    path('posts/<int:year>/<int:month>/<slug:slug>/', post_detail, name='year_post'),
